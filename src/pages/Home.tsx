...
export default function Home() {
    ...
    return (
        <div id="home" className={`flex h-auto md:h-[520px] flex-col-reverse md:flex-row w-full gap-y-5 md:gap-y-0 md:gap-x-5 justify-center md:justify-between pb-5`}>
            <div className="flex h-auto md:h-full w-full md:w-8/12 rounded-3xl animate-slide-up overflow-hidden justify-center items-center ">
                ...
                <div className="flex h-[500px] md:h-full w-full bg-slate-500 bg-opacity-10 p-10 flex-col justify-between z-10">
                    ...
                    <p className={`text-base font-normal my-5`}>{homeData.description}</p>
                    <ContactLinks />
                </div>
            </div>
            <ImageCard />
